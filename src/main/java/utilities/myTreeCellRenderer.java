...
public class myTreeCellRenderer extends JLabel implements TreeCellRenderer {
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        /*
        Color c1,c2;
        if (stringValue.startsWith("SCEN") &&  tree.isExpanded(row) && sel) {

        c1=Color.ORANGE;
        c2=Color.decode("0x0000CC");
        } else {
        c1=DefaultLookup.getColor(this, ui, "Tree.selectionForeground");
        c2=DefaultLookup.getColor(this, ui, "Tree.selectionBackground");
        }
        this.setForeground(c1);
        this.setTextNonSelectionColor(c1);
        this.setBackgroundSelectionColor(c2);
         */

        ImageIcon j = IconFactory.getIcon("java4d/images/icon" + super.getText().substring(0, 4) + ".png");
        if (j == null) 
        ...
        try {
            String t = ((myNode) (tree.getPathForRow(row).getLastPathComponent())).getSect().getTipDetails();
            if (t.length() > 5) {
                tree.setToolTipText("Tip: " + t);
